...
n.innerHTML+=`
            ...
            </button>`),n.querySelectorAll("[data-topage]").forEach(e=>{/* console.log(btn.dataset.topage); */e.addEventListener("click",function(e){e.preventDefault(),M.setPage(Number(e.target.dataset.topage)),i()})})}else n.innerHTML=""})(t.page,t.totalPages,n,B),console.log(t)})}//# sourceMappingURL=index.40be0e49.js.map

//# sourceMappingURL=index.40be0e49.js.map
