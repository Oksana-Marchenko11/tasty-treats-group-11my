 ...
 * _.toNumber('3.2');
 * // => 3.2
 */function b(e){if("number"==typeof e)return e;if("symbol"==typeof(t=e)||t&&"object"==typeof t&&"[object Symbol]"==v.call(t))return l;if(w(e)){var t,n="function"==typeof e.valueOf?e.valueOf():e;e=w(n)?n+"":n}if("string"!=typeof e)return 0===e?e:+e;e=e.replace(C,"");var i=c.test(e);return i||d.test(e)?u(e.slice(2),i?2:8):s.test(e)?l:+e}r=/**
 ...
 */function(e,t,n){var i,a,o,r,l,C,s=0,c=!1,d=!1,u=!0;if("function"!=typeof e)throw TypeError("Expected a function");function g(t){var n=i,o=a;return i=a=void 0,s=t,r=e.apply(o,n)}function p(e){var n=e-C,i=e-s;// Either this is the first call, activity has stopped and we're at the
// trailing edge, the system time has gone backwards and we're treating
// it as the trailing edge, or we've hit the `maxWait` limit.
return void 0===C||n>=t||n<0||d&&i>=o}function f(){var e,n,i,a=L();if(p(a))return v(a);// Restart the timer.
...
(l=void 0,u&&i)?g(e):(i=a=void 0,r))}function y(){var e,n=L(),o=p(n);if(i=arguments,a=this,C=n,o){if(void 0===l)return(// Reset any `maxWait` timer.
s=e=C,// Start the timer for the trailing edge.
l=setTimeout(f,t),c?g(e):r);if(d)return(// Handle invocations in a tight loop.
l=setTimeout(f,t),g(C))}return void 0===l&&(l=setTimeout(f,t)),r}return t=b(t)||0,w(n)&&(c=!!n.leading,o=(d="maxWait"in n)?h(b(n.maxWait)||0,t):o,u="trailing"in n?!!n.trailing:u),y.cancel=function(){void 0!==l&&clearTimeout(l),s=0,i=C=a=l=void 0},y.flush=function(){return void 0===l?r:v(L())},y};var y=i("eMXxl");const M=new a.default,T=document.querySelector(".category-list"),x=document.querySelector(".list-item"),E=document.querySelector(".filter-input"),F=document.querySelector(".area"),$=document.querySelector(".ingrediends"),H=document.querySelector(".time"),S=document.querySelector(".all-category-btn"),q=document.querySelector(".reset-filters");q.addEventListener("click",e=>{document.querySelector(".form-filters").reset(),M.setResetFilters(),B()});for(let e=0;e<=120;e+=5){let t=document.createElement("option");t.value=e||"",t.innerHTML=e+" min",H.appendChild(t)}// triggers
E.addEventListener("input",r(function(e){console.log(e.target.value.trim()),M.setSearchText(e.target.value.trim()),B()},300)),$.addEventListener("change",function(e){console.log(e.target.value),M.setSearchIngredient(e.target.value),B()}),F.addEventListener("change",function(e){console.log(e.target.selectedOptions[0].dataset.param),M.setSearchArea(e.target.selectedOptions[0].dataset.param),B()}),T.addEventListener("click",function(e){T.querySelectorAll(".category-btn").forEach(e=>{e.classList.remove("active-button")}),e.target.classList.add("active-button"),console.log(e.target.dataset.recipeCategory),M.setCategory(e.target.dataset.recipeCategory),B()}),H.addEventListener("change",function(e){console.log(e.target.value),M.setSearchTime(e.target.value),B()}),S.addEventListener("click",function(){M.setCategory(""),B()}),//ОТРИМУЄМО СПИСОК КАТЕГОРІЙ ПРИ ЗАВАНТАЖЕНІ СТОРІНКИ
M.getCategories().then(e=>{e.forEach(e=>{T.innerHTML+=`<li class="category-item-list"><button class="category-btn" data-recipe-category="${e.name}">${e.name}</button></li>`})}),//ОТРИМУЄМО СПИСОК КРАЇН
M.getAreas().then(e=>{let t=document.createElement("option");t.value="",t.innerHTML="Region",t.dataset.param="",F.appendChild(t),e.forEach(e=>{let t=document.createElement("option");t.value=e._id,t.innerHTML=e.name,t.dataset.param=e.name,F.appendChild(t)})}),//ОТРИМУЄМО СПИСОК ІНГРІДІЄНТІВ
M.getIngredients().then(e=>{let t=document.createElement("option");t.value="",t.innerHTML="Product",$.appendChild(t),e.forEach(e=>{let t=document.createElement("option");t.value=e._id,t.innerHTML=e.name,$.appendChild(t)})}),window.onresize=y(function(){B()},500),//ОТРИМУЄМО СПИСОК РЕЦЕПТІВ ПРИ ЗАВАНТАЖЕНІ СТОРІНКИ
B();const k=`
...
<svg width="22" height="22" viewBox="0 0 22 22" fill="white" xmlns="http://www.w3.org/2000/svg">
    <path opacity="1" fill-rule="evenodd" clip-rule="evenodd"
        ...
        2.00948 12.8266 2.5652 10.9939 4.70783Z" stroke="#F8F8F8" stroke-width="2"
        stroke-linecap="round" stroke-linejoin="round"/>
</svg>`;function B(){window.innerWidth<768?M.setPerPage(6):window.innerWidth<1280?M.setPerPage(8):M.setPerPage(9);let e=(0,o.default).getLs();M.getRecipes().then(t=>{x.innerHTML="",t.results.forEach(t=>{let n=t._id in e?"favorite":"unfavorite",i=document.createElement("li");i.className="item-cards",i.innerHTML=`
...
n.innerHTML+=`
            ...
            </button>`),n.querySelectorAll("[data-topage]").forEach(e=>{/* console.log(btn.dataset.topage); */e.addEventListener("click",function(e){e.preventDefault(),M.setPage(Number(e.target.dataset.topage)),i()})})}else n.innerHTML=""})(t.page,t.totalPages,n,B),console.log(t)})}//# sourceMappingURL=index.e60a374a.js.map

//# sourceMappingURL=index.e60a374a.js.map
